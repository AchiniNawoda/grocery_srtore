...
def get_all_products(connection):
    ...
    query =""" SELECT products.product_id, products.name, products.uom_id, products.price_for_unit, uom.uom_name
...
def insert_new_product(connection, product):
    cursor = connection.cursor()
    query = """INSERT INTO products (name, uom_id,price_for_unit) 
            VALUES (%s,%s,%s);"""
